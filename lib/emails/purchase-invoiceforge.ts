...
export function buildInvoiceForgeEmail(
  firstName: string,
  toEmail: string,
  tier: string
): EmailPayload {
  ...
  return {
    from: FROM_ADDRESS,
    to: toEmail,
    subject: "InvoiceForge is active — generate your first invoice now.",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>InvoiceForge — Subscription Confirmed</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#13131a;border:1px solid #1e1e2e;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#ffffff;letter-spacing:-0.5px;">InvoiceForge ${isPro ? "Pro" : "Starter"} is live.</h1>

              <p style="margin:0 0 20px;font-size:16px;color:#a0a0b8;line-height:1.6;">
                Hey ${firstName}, InvoiceForge is now active. Stop chasing payments — let the bot handle it.
              </p>
              <p style="margin:0 0 28px;font-size:16px;color:#a0a0b8;line-height:1.6;">
                ${isPro ? "Pro gives you unlimited invoice generation, custom branding fields, and PDF-ready output." : "Starter lets you generate up to 20 invoices per month — plenty to get paid faster."}
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;background-color:#0d0d14;border:1px solid #1e1e2e;border-radius:8px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 12px;font-size:14px;font-weight:600;color:#ffffff;">What InvoiceForge does:</p>
                    <p style="margin:0 0 8px;font-size:14px;color:#a0a0b8;">✓ Generates professional invoices from plain-text descriptions</p>
                    <p style="margin:0 0 8px;font-size:14px;color:#a0a0b8;">✓ Calculates line items, taxes, and totals automatically</p>
                    <p style="margin:0;font-size:14px;color:#a0a0b8;">✓ Formats output ready to send or paste into your billing tool</p>
                  </td>
                </tr>
              </table>
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
                <tr>
                  <td style="background-color:#00c8ff;border-radius:8px;">
                    <a href="https://botvaultpro.com/dashboard/invoiceforge"
