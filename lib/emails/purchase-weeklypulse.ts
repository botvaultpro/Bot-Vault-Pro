...
export function buildWeeklyPulseEmail(
  ...
  return {
    from: FROM_ADDRESS,
    to: toEmail,
    subject: "WeeklyPulse is active — your first report lands Monday morning.",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>WeeklyPulse — Subscription Confirmed</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#13131a;border:1px solid #1e1e2e;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#ffffff;letter-spacing:-0.5px;">WeeklyPulse ${isPro ? "Pro" : "Starter"} is live.</h1>

              <p style="margin:0 0 20px;font-size:16px;color:#a0a0b8;line-height:1.6;">
                Hey ${firstName}, WeeklyPulse is now active. Every Monday morning, a curated industry report lands in your inbox — no research required.
              </p>
              <p style="margin:0 0 28px;font-size:16px;color:#a0a0b8;line-height:1.6;">
                ${isPro ? "Pro delivers expanded reports with deeper analysis, competitor tracking, and custom keyword monitoring. Expect your first one this Monday." : "Starter delivers a weekly industry digest covering top trends, news, and opportunities in your space. Expect your first one this Monday."}
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;background-color:#0d0d14;border:1px solid #1e1e2e;border-radius:8px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 12px;font-size:14px;font-weight:600;color:#ffffff;">What WeeklyPulse does:</p>
                    <p style="margin:0 0 8px;font-size:14px;color:#a0a0b8;">✓ Scans your industry for trends, shifts, and opportunities every week</p>
                    <p style="margin:0 0 8px;font-size:14px;color:#a0a0b8;">✓ Distills findings into an actionable report delivered to your inbox</p>
                    <p style="margin:0;font-size:14px;color:#a0a0b8;">✓ Keeps you ahead without spending hours on research</p>
                  </td>
                </tr>
              </table>
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
                <tr>
                  <td style="background-color:#00c8ff;border-radius:8px;">
                    <a href="https://botvaultpro.com/dashboard/weeklypulse"
