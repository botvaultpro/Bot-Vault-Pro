    ...
    if (data) {
      ...
      setQuestions(
        (data.questions || [])
          ...
          .map(q => ({
            ...q,
            correct_answer: VALID_ANSWERS.includes(String(q.correct_answer).toUpperCase())
  ...
  async function handleSave() {
    ...
    try {
      ...
      const questionsToSave = validQuestions.map((q, i) => {
        const correctAnswer = VALID_ANSWERS.includes(String(q.correct_answer).toUpperCase())
          ? String(q.correct_answer).toUpperCase()
          : 'A'
