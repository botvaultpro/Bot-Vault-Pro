          ...
          <div className="space-y-6">
            ...
            <div className="card text-center py-8">
              ...
              <button onClick={handleCopyCode} className="flex items-center gap-2 mx-auto text-text-secondary hover:text-white transition-colors text-sm font-dm">
                {copied
                  ? <><Check className="w-4 h-4 text-success" /><span className="text-success">Copied!</span></>
              ...
              <div className="grid grid-cols-2 gap-3 text-center">
                <div>
                  <p className="text-2xl font-syne font-bold text-white">
                    {room?.question_sets?.questions?.length || 0}
                  </p>
            ...
            {players.length === 0 && (
              <p className="text-center text-text-muted text-sm font-dm">
